    ...
    <div class="containet-fluid">        
       <div class="video-caption text-center">
            <div class="wow fadeInLeft" data-wow-offset="1" data-wow-delay="1s">
                <h1><span id="js-rotating">Alice Poker Night,愛麗絲撲克之夜,開啟您美好的賭場夜生活</span></h1>                
            </div>
        ...
        <div class="video-background">
            <video id="video-background" src="./product_img/Comp 1.mp4" muted autoplay loop plays-inline></video>
